...
% Task 4
problem(broken_wheel_mouse) :-
    query('Does the mouse wheel dont work').
problem(broken_key_mouse) :-
    query('Does mouse clicks dont work').
problem(broken_mouse) :-
    query('Does the mouse cursor dont work').
